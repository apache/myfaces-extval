...
@ManagedBean(name = "helloGroupValidationController")
@RequestScoped
public class HelloGroupValidationController
{
    @BeanValidation.List({
            @BeanValidation(useGroups = Default.class),
            @BeanValidation(viewIds = "/pages/groupValidation01.xhtml", useGroups = User.class),
            @BeanValidation(viewIds = "/pages/groupValidation02.xhtml", useGroups = Admin.class),
            @BeanValidation(viewIds = "/pages/modelValidation01.xhtml", useGroups = Admin.class),
            @BeanValidation(viewIds = "/pages/modelValidation01.xhtml", useGroups = Name.class,
