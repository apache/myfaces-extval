...
public class RegistrationValidationExceptionInterceptorTestCase extends AbstractExValViewControllerTestCase
{
    /**
    ...
    public void testValidationExceptionInterceptorInitialization()
    {
        ...
        for(int i = 0; i < resultLength; i++)
        {
            ...
            {
                case 0:
                    assertEquals(TestValidationExceptionInterceptor1.class, result.get(i).getClass());
                    break;
                case 1:
                    assertEquals(TestValidationExceptionInterceptor2.class, result.get(i).getClass());
                    break;
                case 2:
