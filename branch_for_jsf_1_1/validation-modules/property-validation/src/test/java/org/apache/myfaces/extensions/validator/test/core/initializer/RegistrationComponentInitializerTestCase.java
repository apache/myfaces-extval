...
import org.apache.myfaces.extensions.validator.HtmlCoreComponentsComponentInitializer;
...
public class RegistrationComponentInitializerTestCase extends AbstractExValViewControllerTestCase
{
    /**
    ...
    public void testComponentInitializerInitialization()
    {
        ...
        for(int i = 0; i < resultLength; i++)
        {
            ...
            {
                case 0:
                    assertTrue(result.get(i) instanceof TestComponentInitializer1);
                    break;
                case 1:
                    assertTrue(result.get(i) instanceof TestComponentInitializer2);
                    break;
                case 2:
                    assertTrue(result.get(i) instanceof TestComponentInitializer3);
                    break;
                case 3:
                    assertTrue(result.get(i) instanceof HtmlCoreComponentsComponentInitializer);
                    break;
                case 4:
                    assertTrue(result.get(i) instanceof TestComponentInitializer1000);
                    break;
                case 5:
                    assertTrue(result.get(i) instanceof TestComponentInitializer);
                    break;
            }
        }
    }
